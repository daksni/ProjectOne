...
static void settingHowThePlayerShouldBeCalled(Player* player) {
...
static void settingThePlayerGender(Player* player) {
...
static void settingThePlayerClass(Player* player) {
